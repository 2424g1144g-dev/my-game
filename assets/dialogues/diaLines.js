...
DIALOGUE_LINES.watchOpening = [
    ...
    {name: "ツカゴエ　ミツヒロ", lines: [{segments: [{text: " "}], event: [{type: "diaToggle"},{type: "enterToggle"},{type: "background", id: "none", fade: 200}], autoNext: true, dialogueAutoNext: true, wait: 800}]},
    {name: " ", lines: [{segments: [{text: " "}], event: [{type: "background", id: "island", fade: 1000}]}]}
]